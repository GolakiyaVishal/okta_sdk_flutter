package com.devgo.okta_sdk_flutter

import android.app.Activity
import android.content.Context
import android.content.Intent
import androidx.annotation.NonNull
import com.devgo.okta_sdk_flutter.okta.operations.createConfig
import com.devgo.okta_sdk_flutter.okta.entities.AvailableMethods
...
import com.devgo.okta_sdk_flutter.okta.operations.*
...
/** OktaSdkFlutterPlugin */
class OktaSdkFlutterPlugin: FlutterPlugin, MethodCallHandler,
  ...
  companion object {
    fun registerWith(registrar: PluginRegistry.Registrar) {
      val plugin = OktaSdkFlutterPlugin()
  ...
  private fun onAttachedToEngine(context: Context, binaryMessenger: BinaryMessenger) {
    ...
    channel = MethodChannel(binaryMessenger, "com.devgo.okta_sdk_flutter")
